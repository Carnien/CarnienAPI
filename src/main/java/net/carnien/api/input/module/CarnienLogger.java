...
import net.carnien.api.input.module.carnienlogger.listener.CarnienLoggerListener;
...
public class CarnienLogger extends Module {

    public CarnienLogger(Carnien carnien) {
        super(carnien);
        addListener(new CarnienLoggerListener(getCarnien()));
    }
    ...
    public void sendPermissionDeniedError(CommandSender target) {
        sendError(target, "You have no permission to execute that command.");
    }
